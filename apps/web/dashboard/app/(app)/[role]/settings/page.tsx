...
const INTEGRATIONS: Integration[] = [
  ...
  {
    title: 'Custom Workflow Webhook',
    description: 'Trigger custom automation pipelines on error events',
    action: (
      <button className="px-4 py-2 bg-[#52b788] text-white font-bold text-xs rounded-full">
        Test Custom Alert
      </button>
    ...
    <div className="rounded-3xl bg-white border border-[#E2E8E4] p-6 shadow-sm space-y-6">
      <div>
        ...
        <p className="text-xs text-[#687870]">
          Configure Slack webhooks and Razorpay subscription webhooks
        </p>
      </div>
