...
export const metadata = {
  title: 'Super Admin - Data & Content Moderation | LiteTrace',
  description: 'Global search, event debugging, and data export tools.',
};
...
export default async function SuperAdminDataPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] space-y-4 bg-white border border-[#E2E8E4] rounded-2xl shadow-sm p-12 text-center">
      ...
      <h1 className="text-2xl font-extrabold text-[#13221C]">Data & Content Moderation</h1>
      <p className="text-[#687870] max-w-md mx-auto font-medium leading-relaxed">
        This platform control capability is planned post-MVP. It will include support-access event debugging, global searches, DPDP compliance overrides, and data exports.
      </p>
    </div>
  );
}
