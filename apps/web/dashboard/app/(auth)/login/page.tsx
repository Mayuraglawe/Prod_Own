      ...
      <div className="hidden md:flex md:w-1/2 relative p-12 flex-col justify-between overflow-hidden z-10 border-r border-white/[0.05]">
        ...
        <div className="relative z-10 space-y-6 max-w-md">
          ...
          <p className="text-white/50 text-lg font-light leading-relaxed">
            Gain unparalleled visibility into your application's health. 
            Self-hosted, modular, and built for complete data ownership.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative z-10">
        ...
        <div className="w-full max-w-sm space-y-8 relative z-10">
          <div className="space-y-2 text-center">
            ...
            <p className="text-white/50 font-light text-[14px]">Sign in to your account to continue</p>
          </div>
          ...
          <div className="text-center text-[13px] text-white/40 mt-6">
            ...
            <Link href="/register" className="text-white hover:text-[#F97316] transition-colors font-medium">
              Sign up
            </Link>
          </div>
        </div>
