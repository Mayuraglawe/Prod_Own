...
export function Header({
  ...
  return (
    <header className="sticky top-4 z-30 w-full min-w-0 mb-6 transition-all">
      {/* Floating rounded card */}
      <div className="bg-white/85 backdrop-blur-xl border border-[#E2E8E4]/80 rounded-2xl shadow-sm shadow-[#13221C]/5 px-4 py-2.5">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-12 py-2 border rounded-full text-sm placeholder-[#9CA3AF] focus:outline-none transition-all shadow-sm bg-white/70 border-[#E2E8E4] text-[#13221C] focus:ring-2 focus:ring-[#0B4F3A]/20"
              />
